...
class UE:
    ...
    def _create_sip_register_1_payload(self, pdn_ip, pcscf_ip):
        ...
        sip_msg = (
            f"REGISTER sip:ims.mnc092.mcc466.3gppnetwork.org SIP/2.0\r\n"
            f"From: <sip:{self.imsi}@ims.mnc092.mcc466.3gppnetwork.org>;tag={self.sip_tag}\r\n"
            f"To: <sip:{self.imsi}@ims.mnc092.mcc466.3gppnetwork.org>\r\n"
            ...
            f"Authorization: Digest uri=\"sip:ims.mnc092.mcc466.3gppnetwork.org\",username=\"{self.imsi}@ims.mnc092.mcc466.3gppnetwork.org\",response=\"\",realm=\"ims.mnc092.mcc466.3gppnetwork.org\",nonce=\"\"\r\n"
    ...
    def _create_sip_register_2_payload(self, pdn_ip, pcscf_ip):
        ...
        sip_msg = (
            ...
            "Supported: path,sec-agree\r\n"
            "Allow: INVITE,BYE,CANCEL,ACK,NOTIFY,UPDATE,PRACK,INFO,MESSAGE,OPTIONS\r\n"
            f"Authorization: Digest username=\"{self.imsi}@ims.mnc092.mcc466.3gppnetwork.org\",realm=\"ims.mnc092.mcc466.3gppnetwork.org\",uri=\"sip:ims.mnc092.mcc466.3gppnetwork.org\",qop=auth,nonce=\"{self.sip_nonce}\",nc=00000001,cnonce=\"4149304045\",algorithm=AKAv1-MD5,response=\"{self.sip_response}\"\r\n"
            "User-Agent: Xiaomi_Redmi K40S_V13.0.11.0.SLMCNXM\r\n"
            "Content-Length: 0\r\n\r\n"
        ).encode('utf-8')
